        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item ">
                        <a class="nav-link" href="<?= base_url('games/premium') ?>">Game Premium <span class="sr-only">(current)</span></a>
                    </li>
            ...
            <div class="col-md-6 mx-auto my-auto mt-5">
                <form action="<?= base_url('welcome/registration') ?>" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control effect-9" name="nama" id="nama_lengkap" value="<?= set_value('nama'); ?>">
                                ...
                                <form>
                                    <div class="form-group">
                                        <label class="label-font" for="exampleFormControlInput1">
                                            Email.</label>
                                        <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Masukan username mu disini ..">
                                    </div>
                                    <div class="form-group">
                                        <label class="label-font" for="exampleFormControlInput1">Password.</label>
                                        <input type="password" class="form-control" id="exampleFormControlInput1" placeholder="Masukan password mu disini ..">
                                    </div>
                                    <div class="form-check mt-2">
